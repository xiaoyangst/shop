...
const file_user_proto_rawDesc = "" +
	...
	"\bPageInfo\x12\x1c\n" +
	"\tpageIndex\x18\x01 \x01(\rR\tpageIndex\x12\x1a\n" +
	...
	"\x04data\x18\x02 \x03(\v2\x11.UserInfoResponseR\x04data2\xc4\x02\n" +
	"\vUserService\x12+\n" +
...
var file_user_proto_goTypes = []any{
	...
	(*CheckPasswordInfo)(nil),     // 6: CheckPasswordInfo
...
var file_user_proto_depIdxs = []int32{
	...
	0, // 1: UserService.GetUserList:input_type -> PageInfo
	1, // 2: UserService.GetUserByMobile:input_type -> MobileRequest
	2, // 3: UserService.GetUserById:input_type -> IdRequest
	4, // 4: UserService.CreateUser:input_type -> CreateUserInfo
	5, // 5: UserService.UpdateUser:input_type -> UpdateUserInfo
	6, // 6: UserService.CheckPassword:input_type -> CheckPasswordInfo
	8, // 7: UserService.GetUserList:output_type -> UserListResponse
	3, // 8: UserService.GetUserByMobile:output_type -> UserInfoResponse
	3, // 9: UserService.GetUserById:output_type -> UserInfoResponse
	3, // 10: UserService.CreateUser:output_type -> UserInfoResponse
	9, // 11: UserService.UpdateUser:output_type -> google.protobuf.Empty
	7, // 12: UserService.CheckPassword:output_type -> CheckPasswordResponse
